...
- `variant-scores_rnaseq_decodeme_significant_all-tissues.csv.gz` - All scores returned by AlphaGenome. (121 MB)
- `variant-scores_rnaseq_decodeme_significant_brain_protein-coding.csv.gz` - Only scores for brain expression of protein coding genes. (87 KB)
